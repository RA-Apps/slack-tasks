  ...
  view: {
    ...
    blocks: [
      ...
      },
      {
        ...
        label: { type: 'plain_text', text: 'Срок исполнения', emoji: true },
        optional: true,
        dispatch_action: false,
      ...
      },
      {
        ...
        label: { type: 'plain_text', text: 'Время', emoji: true },
        optional: true,
        dispatch_action: false,
    ...
    title: { type: 'plain_text', text: 'Создать новую задачу', emoji: true },
